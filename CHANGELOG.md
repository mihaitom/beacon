...
- The volume slider on the phone snapped back to roughly where the drag began after being let go while casting to a speaker. Dragging it now sets the level on the speaker once, when you let go, the way the phone's Remote Control has always done it. The slider follows the finger while it moves, and the level the speaker reports back no longer lands on it while a change is still on its way there
