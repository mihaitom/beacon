...
- Surround tracks, a 5.1 FLAC for instance, stayed completely silent when cast. They are now folded down to stereo for the speaker, which is what every cast target can actually play, and the stream info names the source's channel count so the downmix has a visible reason
