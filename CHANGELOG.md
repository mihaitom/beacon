...
- The volume slider snapped back to roughly where the drag began after being let go while casting to a speaker, most visibly on a phone. The speaker is now told the new level one command at a time and ends up at the one you let go at, and the level it reports back no longer lands on the slider while a change is still on its way to it
