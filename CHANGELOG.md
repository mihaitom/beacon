...
- A speaker that cannot be paused, resumed or added to a running cast now gets a proper message in the device list, naming it and what went wrong. Pausing and resuming used to fail without a word, and adding a speaker showed the raw error code
