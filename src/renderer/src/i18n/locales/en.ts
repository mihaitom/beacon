...
export default {
  ...
  nowPlaying: {
    ...
    nextBackground: 'Show another background',
  ...
  lastfm: {
    ...
    artist: 'Artist',
    seedTrack: 'Track',
    seedTrackPlaceholder: 'Search your library…',
    seedHint: 'Type to search your library',
    seedNoResults: 'No matches',
    ...
    queueMenu: 'Queue',
    newQueue: 'Replace the queue',
    appendQueue: 'Add to the queue',
  ...
  stats: {
    ...
    storage: 'Storage',
    playedShare: 'of the library played',
    recentlyPlayed: 'songs played in the last 30 days',
    favoritesTitle: 'Favorites & ratings',
    ...
    largestArtistsTitle: 'Most represented artists',
    decade: '{decade}s',
    days: '{days}d {hours}h',
