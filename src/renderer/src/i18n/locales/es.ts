...
export default {
  ...
  home: {
    ...
    topTracks: 'Pistas más reproducidas',
  ...
  library: {
    ...
    noTracksForQuery: 'No hay pistas para "{query}".',
    album1: 'álbum',
    albumsN: 'álbumes',
    track1: 'pista',
    tracksN: 'pistas',
    songCount: '{count} pistas',
    ...
    trackRadio: 'Radio de la pista',
    trackRadioError: 'No se pudo iniciar la radio de la pista.',
  ...
  lyrics: {
    title: 'Letra',
    notFound: 'No se encontró letra para esta pista.',
  ...
  remoteControl: {
    ...
    hint: 'Permite que un teléfono en tu red controle la reproducción — Reproduciendo ahora, Cola, Listas de reproducción, Pistas y Radio.',
  ...
  settings: {
    ...
    scanComplete: 'Escaneo completo — {count} pistas procesadas.',
    ...
    libraryRefreshed: 'Biblioteca actualizada — {count} pistas cargadas.',
  ...
  stats: {
    ...
    favoriteTracks: 'Pistas favoritas',
