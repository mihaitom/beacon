...
export default {
  ...
  home: {
    ...
    newArtistsTitle: 'Nuove da scoprire',
  },
  library: {
    album: 'Album',
    artist: 'Artista',
    ...
    noTracksFound: 'Nessun brano trovato.',
    noTracksForQuery: 'Nessun brano per "{query}".',
    album1: 'album',
    albumsN: 'album',
    track1: 'brano',
    tracksN: 'brani',
    ...
    trackRadio: 'Radio del brano',
    trackRadioError: 'Impossibile avviare la radio del brano.',
  ...
  lyrics: {
    ...
    source: 'Fonte: {source}',
    sourceFile: 'Dal file',
    pickMatch: 'Altra corrispondenza',
  ...
  stats: {
    ...
    favoriteTracks: 'Brani preferiti',
