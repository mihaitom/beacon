  ...
  privacy: {
    ...
    services: {
      ...
      musicbrainz: {
        name: 'MusicBrainz',
        purpose:
          'Associa i nomi degli artisti a un identificativo stabile, su cui si basano i consigli. Serve anche per i collegamenti nella pagina di un artista, che i consigli siano attivi o no.',
