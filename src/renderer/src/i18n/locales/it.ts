...
export default {
  ...
  nowPlaying: {
    ...
    nextBackground: 'Mostra un altro sfondo',
  ...
  lastfm: {
    ...
    artist: 'Artista',
    seedTrack: 'Brano',
    seedTrackPlaceholder: 'Cerca nella tua libreria…',
    seedHint: 'Digita per cercare nella tua libreria',
    seedNoResults: 'Nessun risultato',
    ...
    playFailed: 'Impossibile avviare la riproduzione.',
    queueMenu: 'Coda',
    newQueue: 'Sostituisci la coda',
    appendQueue: 'Aggiungi alla coda',
  ...
  favorites: {
    ...
    countArtists: '{n} artista | {n} artisti',
    countAlbums: '{n} album | {n} album',
    countSongs: '{n} brano | {n} brani',
    title: 'Preferiti',
    artists: 'Artisti',
    albums: 'Album',
    songs: 'Brani',
  ...
  stats: {
    ...
    playedShare: 'della libreria ascoltata',
    recentlyPlayed: 'brani ascoltati negli ultimi 30 giorni',
    favoritesTitle: 'Preferiti e valutazioni',
    ratedSongs: 'Brani valutati',
    ...
    largestArtistsTitle: 'Artisti più presenti',
    decade: '{decade}s',
    days: '{days}g {hours}h',
