...
export default {
  ...
  home: {
    ...
    newArtistsTitle: 'Nouveau à explorer',
  },
  library: {
    album: 'Album',
    artist: 'Artiste',
    ...
    noTracksFound: 'Aucun titre trouvé.',
    noTracksForQuery: 'Aucun titre pour « {query} ».',
    album1: 'album',
    albumsN: 'albums',
    track1: 'titre',
    tracksN: 'titres',
    ...
    trackRadioError: 'Impossible de démarrer la radio du titre.',
