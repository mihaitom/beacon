<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="plex-icon">
    <path
      fill="#EBAF00"
...
<script lang="ts">
// Official mark (simple-icons project, CC0) — see JellyfinIcon.vue's
// comment for why this uses a fixed brand color rather than currentColor.
export default {
  name: 'PlexIcon',
}
</script>
